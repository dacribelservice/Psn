    ...
    <div className="bg-surface-dim text-on-surface min-h-screen flex items-center justify-center p-4 text-center">
      <main className="w-full max-w-md mx-auto">
        ...
        <div className="glass-vault rounded-[2rem] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          {/* SSO Integration */}
          <button className="w-full bg-surface-container-highest hover:bg-surface-bright transition-all duration-300 rounded-xl py-4 px-6 flex items-center justify-center gap-3 group mb-6">
            ...
            <span className="text-on-surface font-semibold text-sm tracking-wide">
              {language === "es" ? "Crea tú cuenta con Google" : "Create account with Google"}
            </span>
          </button>
          ...
          <div className="flex items-center gap-4 mb-6 text-center">
            ...
            <span className="text-[10px] font-bold text-secondary/40 uppercase tracking-widest">
              {language === "es" ? "o Crea tú cuenta con Email" : "or Create account with Email"}
            </span>
            <div className="h-[1px] flex-1 bg-secondary/10"></div>
          </div>
